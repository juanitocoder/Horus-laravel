<section class="container py-16 mx-auto" id="nosotros">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <h2 class="relative text-4xl font-extrabold text-center mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-5 flex flex-col">
                ...
                <div class="bg-gradient-to-br from-gray-900 to-black rounded-2xl shadow-xl overflow-hidden mb-6 transform transition hover:shadow-2xl hover:shadow-amber-500/20 duration-300">
                    <div class="relative">
                ...
                <!-- Video en tarjeta separada -->
                <div class="bg-gradient-to-br from-gray-900 to-black rounded-2xl shadow-xl overflow-hidden flex-grow transform transition hover:shadow-2xl hover:shadow-amber-500/20 duration-300">
                    <div class="p-5">
                        <h3 class="text-lg font-medium text-amber-400 mb-3">Descubre nuestro proceso</h3>
                        
                        <!-- Video mejorado con overlay y efecto -->
                        <div class="rounded-xl overflow-hidden relative group">
                            ...
                            <div class="absolute inset-0 border-2 border-amber-500 opacity-0 group-hover:opacity-100 rounded-xl transition duration-300 z-20 transform scale-[0.98] group-hover:scale-100"></div>
                            
                            <iframe class="w-full h-64 md:h-72 rounded-xl relative z-0"
                                src="https://www.youtube.com/embed/1MiRcgNHM1c?autoplay=1&loop=1&playlist=1MiRcgNHM1c"
                            ...
                            <!-- Botón de play superpuesto para mejor UX -->
                            <div class="absolute inset-0 flex items-center justify-center z-30 pointer-events-none">
                                <div class="w-16 h-16 bg-amber-500/80 rounded-full flex items-center justify-center group-hover:opacity-0 transition-opacity duration-300">
            ...
            <!-- Columna Derecha (manteniendo el diseño anterior) -->
            <div class="md:col-span-7 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-8 rounded-2xl shadow-xl border border-gray-700 flex flex-col justify-between transform transition hover:shadow-2xl hover:shadow-amber-500/20 duration-300">
                <div>
                    ...
                    <div class="space-y-10 mt-8">
                        ...
                        <div class="flex items-start space-x-6 group">
                            <div class="w-16 h-16 rounded-full flex items-center justify-center bg-gray-700 group-hover:bg-amber-600 transition-colors duration-300">
                ...
                <div class="mt-12 text-center">
                    <div class="inline-block bg-gradient-to-r from-amber-500 to-yellow-500 p-px rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
                        <a href="/hombres" class="block bg-gray-800 text-amber-300 hover:text-white px-8 py-4 rounded-lg font-semibold transition duration-300">
                            Descubre nuestras colecciones
                            <svg class="inline-block w-5 h-5 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
