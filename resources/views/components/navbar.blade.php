                    ...
                    @auth
                        ...
                        @if(Auth::user()->role->name === 'admin'|| Auth::user()->role->name === 'superadmin')
                            <div class="mb-6 space-y-2">
                                ...
                                <a href="/crear" class="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-800 transition" onclick="event.preventDefault(); showLoader(); window.location.href=this.href;">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                    </svg>
                                    <span>Nuevo producto</span>
                                </a>
                                <a href="{{ route('admin.comentarios') }}" class="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-800 transition" onclick="event.preventDefault(); showLoader(); window.location.href=this.href;">
