                                   ...
                                   <!-- Categoría -->
                                    <div>
                                        ...
                                        <select name="category_id" id="category_id"
                                            class="block w-full px-4 py-3 rounded-lg border border-[#3d3f56] shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-[#2a2c42] text-gray-200">
                                    ...
                                    <!-- Promoción (solo si categoria es “Promociones” con id 4) -->
                                    <div id="promotionField" class="{{ old('category_id', $product->category_id) == 4 ? '' : 'hidden' }} mt-4">
                                        <label for="promotion_id" class="block text-sm font-medium text-gray-300 mb-1">
                                            Tipo de Promoción
                                        </label>
                                        <select name="promotion_id" id="promotion_id"
                                            ...
                                            @foreach($promociones as $promo)
                                                <option value="{{ $promo->id }}"
                                                    {{ old('promotion_id', $product->promotion_id) == $promo->id ? 'selected' : '' }}>
                                                    {{ $promo->name }}
                                                </option>
                                            @endforeach
                                        </select>
